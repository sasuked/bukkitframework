package io.github.sasuked.config;
...
public class YamlConfig {
  ...
  public YamlConfig(Plugin owningPlugin, String name) {
  ...
  public void load(File file) throws java.io.FileNotFoundException, java.io.IOException, org.bukkit.configuration.InvalidConfigurationException {
  ...
  public void load(String file) throws java.io.FileNotFoundException, java.io.IOException, org.bukkit.configuration.InvalidConfigurationException {
    this.configuration.load(file);
  }
