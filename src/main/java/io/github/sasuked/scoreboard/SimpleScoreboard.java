package io.github.sasuked.scoreboard;

import io.github.sasuked.reflection.ReflectionUtils;
...
public class SimpleScoreboard {
  ...
  /**
   * Creates a new SimpleScoreboard.
   *
   ...
   *
   * @return current player for this SimpleScoreboard
   */
  ...
  /**
   * Delete this SimpleScoreboard, and will remove the scoreboard for the associated player if he is online.
  ...
  private void sendPacket(Object packet) throws ReflectiveOperationException {
    if (deleted) {
      throw new IllegalStateException("This SimpleScoreboard is deleted");
    }
